...
ActiveRecord::Schema[7.2].define(version: 2026_06_16_000002) do
  ...
  create_table "redbark_accounts", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["account_id"], name: "index_redbark_accounts_on_account_id"
    t.index ["redbark_item_id", "account_id"], name: "index_redbark_accounts_on_item_and_account_id", unique: true, where: "(account_id IS NOT NULL)"
