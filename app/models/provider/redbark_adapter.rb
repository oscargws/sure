class Provider::RedbarkAdapter < Provider::Base
  ...
  def self.connection_configs(family:)
    ...
    [ {
      key: "redbark",
      name: "Redbark",
      description: "Connect your Australian bank via Redbark",
      can_connect: true,
  ...
  # Redbark is now fully per-family - no global credentials supported
  # @param family [Family] The family to get credentials for (required)
  # @return [Provider::Redbark, nil] Returns nil if API key is not configured
  def self.build_provider(family: nil)
    ...
    Provider::Redbark.new(
      ...
      base_url: redbark_item.effective_base_url
    )
  end
  ...
  def institution_domain
    # Redbark may provide institution metadata in account data
